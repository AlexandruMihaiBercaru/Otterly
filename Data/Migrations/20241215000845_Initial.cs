        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_projects_AspNetUsers_organizer_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    project_id = table.Column<Guid>(type: "char(36)", nullable: false, collation: "ascii_general_ci"),
                    ended_at = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: true),
                    joined_at = table.Column<DateTimeOffset>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_memberships", x => new { x.user_id, x.project_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    label_id = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_tasks", x => x.id);
                    table.ForeignKey(
                        name: "FK_tasks_labels_label_id",
                        column: x => x.label_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_memberships_project_id",
                table: "memberships",
                column: "project_id");

            migrationBuilder.CreateIndex(
                name: "IX_projects_organizer_id",
                table: "projects",
                column: "organizer_id");

            migrationBuilder.CreateIndex(
                name: "IX_tasks_label_id",
                table: "tasks",
                column: "label_id");
